  ...
  return (
    <>
      <Grid item xs={12} md={12} lg={12}>
        <h2 className="page__header">Создать закупку</h2>
        <Paper
          sx={{
            p: 2,
            display: 'flex',
            ...
            >
              <div className="updata__content">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="form-group">
                    <label htmlFor="description">Описанеие</label>
                    <input
                      type="text"
                      name="description"
                      className="form-control create__product--input"
                  ...
                  <div className="form-group">
                    <label htmlFor="content">Характеристики</label>
                    <textarea
                      name="content"
                      className="form-control create__product--input"
                      id="content"
                  ...
                  <div>
                    <Button
                      ...
                      type="submit"
                    >
                      {onEdit ? 'Обновить закуп' : 'Создать закуп'}
                    </Button>
                  </div>
                </form>
              </div>
            ...
            <Table size="medium">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell className="order__item">Рисунок</TableCell>
                  <TableCell className="order__item">Цена</TableCell>
                  <TableCell className="order__item">
                    Завершенныз закупок
                  </TableCell>
                  <TableCell className="order__item">Категория</TableCell>
